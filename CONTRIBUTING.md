...
- Run `npm run test:all` before proposing a change; use the commands in README to install development tools. Review desktop/mobile layout and keyboard operation when the UI changes.
